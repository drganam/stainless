...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  def concat1(l1: List[BigInt], l2: List[BigInt]): List[BigInt] = {
    if(l2.isEmpty) l1
    else concat1(l1 ++ List(l2.head), l2.tail)
  }

  def concat2(l1: List[BigInt], l2: List[BigInt]): List[BigInt] = {
    l1 ++ l2
  }

  @induct @funEq
  def concat_check(l1: List[BigInt], l2: List[BigInt]): Boolean = {
    concat1(l1, l2) == concat2(l1, l2)
  }.holds
